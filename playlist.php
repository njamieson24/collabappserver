...
<div class="party-info">
      <?php
        ...
        if(isset($_GET['track.name']) && isset($_GET['track.artists[0].name']) && isset($_GET['track.album.images[0].url'])){
            $song_name = $_GET['song_name'];
            $artist_name = $_GET['artist_name'];
            $album_image = $_GET['album_image'];

            $sql="INSERT INTO song_queue (song_name, artist_name, album_image)
